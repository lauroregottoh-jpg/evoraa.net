    ...
    <CinematicLayout>
      ...
      <section className="py-14 px-6 sm:px-12 lg:px-20 bg-[#F2EBE0]">
        <div className="max-w-5xl mx-auto space-y-8">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <h2 className="font-serif text-3xl font-bold text-[#A07070]">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <h3 className="font-serif text-xl font-bold text-[#A07070]">
                Pour les célibataires
              </h3>
      ...
      >
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <article className="rounded-2xl border border-[#A07070]/15 bg-[#F2EBE0] p-6 sm:p-8 flex flex-col gap-4">
