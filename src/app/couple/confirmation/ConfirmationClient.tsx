  ...
  return (
    <CouplePageFrame>
      <div className="max-w-2xl mx-auto space-y-8 py-6 px-1">
        ...
        <div className="space-y-4 rounded-2xl border border-[#7F5557]/10 bg-white p-5 sm:p-6">
          <h2 className="font-serif text-xl font-bold text-[#7F5557]">
            Partagez l’accès — {COUPLE_BRAND}
          </h2>
          <p className="text-sm text-[#7F5557]/80 leading-relaxed">
          ...
          {inviteCode ? (
            <div className="rounded-xl border border-[#B8954A]/40 bg-[#F2EBE0] p-4 space-y-1">
              <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
                Code à communiquer
              </p>
              <p className="font-mono text-2xl font-bold tracking-widest text-[#7F5557]">
                {inviteCode}
              </p>
              <button
                type="button"
          ...
          {tokenPath && !inviteCode ? (
            <p className="text-xs rounded-xl border bg-[#F2EBE0] px-3 py-2 break-all">
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            ...
            <Link
              href="/couple/espace"
              className="inline-flex h-11 items-center rounded-xl bg-[#7F5557] text-white px-5 text-sm font-semibold"
            >
              Ouvrir notre espace
            </Link>
            <Link
              href="/couple/inviter"
              className="inline-flex h-11 items-center rounded-xl border border-[#7F5557]/15 px-5 text-sm font-semibold"
            >
              Voir / régénérer
            </Link>
          </div>
