  ...
  if (isDemo && paymentId) {
    return (
      <div className="max-w-lg mx-auto space-y-4 py-10 px-4">
        <h1 className="font-serif text-3xl font-bold text-[#2D1020]">
          Confirmation démo
        </h1>
        <p className="text-sm text-[#2D1020]/70 leading-relaxed">
          Offre :{" "}
          <span className="font-medium text-[#2D1020]">
        ...
        <p className="text-sm leading-relaxed text-[#2D1020]/80">
        ...
        <button
          ...
          className="inline-flex h-11 items-center justify-center rounded-xl bg-[#2D1020] text-white px-5 text-sm font-semibold disabled:opacity-60"
        >
        ...
        <Link href="/couple/offre" className="text-sm font-semibold text-[#2D1020]">
          ← Retour aux offres
        </Link>
      </div>
    )
  ...
  return (
    <div className="max-w-xl mx-auto py-10 px-4 sm:px-6">
      <div className="mb-6 space-y-1">
        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#2D1020]">
          KELYA Couple
        </p>
        <h1 className="font-serif text-3xl font-bold text-[#2D1020]">
          Paiement du bilan
        </h1>
        <p className="text-sm text-[#2D1020]/65">
