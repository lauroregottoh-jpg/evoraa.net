  ...
  return (
    <MemberPage>
      <div className="space-y-6 py-4 max-w-5xl mx-auto">
        <header className="relative overflow-hidden rounded-[1.75rem] border border-[#B8954A]/35 bg-gradient-to-br from-[#FFFBF5] via-[#F2EBE0] to-[#F0E6D4] p-6 sm:p-8 shadow-card">
          ...
          <h1 className="mt-2 font-serif text-3xl sm:text-4xl font-bold text-[#7F5557]">
            Découvrir la communauté
          </h1>
          <p className="mt-2 max-w-2xl text-sm text-[#7F5557]/70 leading-relaxed">
