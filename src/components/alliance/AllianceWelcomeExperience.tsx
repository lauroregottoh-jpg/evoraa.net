...
export function AllianceWelcomeExperience({
  ...
  return (
    <div className="min-h-[70vh]">
      ...
      {phase === "cinema" ? (
        <section className="relative overflow-hidden rounded-[1.75rem] bg-[#120f10] text-[#F2EBE0] px-6 py-16 sm:py-20 text-center shadow-elevated">
          ...
          <button
            ...
            className="mt-8 inline-flex h-11 items-center rounded-xl bg-[#B8954A] px-6 text-sm font-bold text-[#2D1020]"
          >
      ...
      {phase === "privileges" ? (
        <section className="rounded-[1.75rem] border border-accent/30 bg-gradient-to-br from-[#2D1020] via-[#722F37] to-[#3D1830] p-6 sm:p-8 text-[#F2EBE0] space-y-5">
