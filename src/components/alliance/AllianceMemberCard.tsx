...
export function AllianceMemberCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-[1.35rem] border border-[#B8954A]/40 bg-[#1C1412] text-[#F8F4EE] p-5 sm:p-6 shadow-elevated">
      <div
        aria-hidden
      ...
      <div className="relative z-10 flex items-start justify-between gap-3">
        ...
        <span className="flex h-11 w-11 items-center justify-center rounded-xl border border-[#B8954A]/45 bg-[#B8954A]/15">
          <Crown className="h-5 w-5 text-[#F3D9A4]" />
        </span>
      </div>
      <div className="relative z-10 mt-5 flex flex-wrap items-center gap-3 text-xs">
        ...
        <span className="inline-flex items-center gap-1.5 rounded-full border border-[#B8954A]/35 bg-[#B8954A]/10 px-3 py-1 text-[#F3D9A4]">
          <BadgeCheck className="h-3.5 w-3.5" /> Badge Alliance
        </span>
      </div>
      <Link
        href="/billing"
        className="relative z-10 mt-4 inline-block text-[11px] font-semibold text-[#F3D9A4]/90 underline underline-offset-2"
      >
