...
export function AdminLoyaltyAllianceNote() {
  return (
    <div className="rounded-xl border border-[#B8954A]/35 bg-[#FFFBF5] px-4 py-3 text-xs text-[#7F5557]/80 space-y-1.5">
      <p className="font-bold text-[#7F5557]">Programme Fidélité Alliance</p>
      <p>
