...
export function CommunityMatchingCta({
  ...
  return (
    <aside className="relative overflow-hidden rounded-2xl border border-[#5C1F28]/20 bg-gradient-to-br from-[#5C1F28] via-[#4A1820] to-[#2A1810] text-[#F8F4EE] p-5 sm:p-6">
      <div className="space-y-3 max-w-2xl">
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          <Link
            href="/assessments"
            className="inline-flex h-11 items-center rounded-xl bg-[#F3D9A4] px-5 text-sm font-semibold text-[#5C1F28]"
          >
...
export function CommunityHeroWithVideo() {
  return (
    <div className="space-y-4">
      ...
      <section className="hidden md:block rounded-2xl border border-[#5C1F28]/20 bg-[#FBF9F6] p-4 sm:p-5 shadow-card">
        <div className="overflow-hidden rounded-xl border border-[#5C1F28]/25 bg-black shadow-sm">
          <video
        ...
        <div className="mt-4 flex flex-wrap gap-2 justify-center">
          ...
          <Link
            href="/compatibility"
            className="inline-flex h-11 items-center rounded-xl border border-[#5C1F28]/30 px-5 text-sm font-semibold text-[#5C1F28]"
          >
            Voir le Matching
          </Link>
        </div>
...
export function KeliaaTestVideoBlock() {
  return (
    <section className="rounded-2xl border border-[#5C1F28]/15 bg-[#FBF9F6] p-4 sm:p-5 space-y-3">
      <div>
        ...
        <p className="text-sm text-[#1C1412]/65 mt-1">
          Comprendre le parcours tests → matching, en images.
        </p>
      </div>
      <div className="relative w-full overflow-hidden rounded-xl border border-[#5C1F28]/20 bg-[#1C1412] shadow-sm">
        <video
