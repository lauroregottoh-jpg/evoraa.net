...
export function LoyaltyProgramCard({
  ...
  return (
    <section
      className={cn(
        "relative overflow-hidden rounded-[1.75rem] border border-[#B8954A]/40 bg-gradient-to-br from-[#FFFBF5] via-[#F8F4EE] to-[#F0E6D4] shadow-card",
      ...
      <div className="relative z-10 space-y-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-1">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#1C1412]">
          ...
          <span className="rounded-full border border-[#B8954A]/40 bg-white px-3 py-1 text-[11px] font-bold text-[#5C1F28]">
        ...
        <div className="rounded-2xl border border-[#B8954A]/25 bg-white/80 p-4 space-y-3">
          ...
          <div className="h-2.5 overflow-hidden rounded-full bg-[#E8D5B5]">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#B8954A] to-[#5C1F28] transition-all"
              style={{ width: `${progress}%` }}
            />
          </div>
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="rounded-xl border border-[#B8954A]/20 bg-[#F7F0E0]/60 p-2.5">
              <p className="text-[10px] font-bold uppercase tracking-wide text-[#8B6914]">
                Prochaine récompense
              </p>
              <p className="mt-1 font-semibold text-[#1C1412]">
            ...
            <div className="rounded-xl border border-[#B8954A]/20 bg-[#F7F0E0]/60 p-2.5">
              ...
              <p className="mt-1 font-semibold text-[#1C1412] inline-flex items-center gap-1">
        ...
        {!compact ? (
          <details className="rounded-xl border border-[#B8954A]/25 bg-white/70 px-4 py-3 text-sm">
            <summary className="cursor-pointer font-semibold text-[#5C1F28]">
              En savoir plus
            </summary>
            <ul className="mt-2 space-y-1.5 text-xs text-[#1C1412]/70 list-disc pl-4">
          ...
          <Link
            ...
            className="inline-flex text-xs font-bold text-[#5C1F28] underline"
          >
            Voir le programme →
          </Link>
        )}
  ...
  return (
    <div className="loyalty-reward-reveal fixed inset-0 z-[80] flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-md overflow-hidden rounded-[1.75rem] border-2 border-[#B8954A]/50 bg-gradient-to-br from-[#FFFBF5] to-[#F0E6D4] p-6 shadow-elevated text-center space-y-4">
        ...
        <h2 className="relative font-serif text-2xl font-bold text-[#1C1412]">
          {milestone
            ? "Félicitations ! Nouveau palier"
            : "Merci pour votre fidélité !"}
        </h2>
        <p className="relative text-sm text-[#1C1412]/70">
          Vous venez de recevoir :
        </p>
        <ul className="relative space-y-2 text-sm font-semibold text-[#1C1412]">
        ...
        <button
          type="button"
          onClick={onContinue}
          className="relative inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#5C1F28] text-sm font-bold text-[#F8F4EE]"
        >
          Continuer
        </button>
      </div>
...
export function PricingLoyaltyTeaser() {
  return (
    <section className="rounded-[1.75rem] border border-[#B8954A]/35 bg-gradient-to-br from-[#FFFBF5] via-white to-[#F8F4EE] p-6 sm:p-8 shadow-card space-y-3">
      ...
      <ul className="grid sm:grid-cols-2 gap-2 text-xs text-[#1C1412]/75">
