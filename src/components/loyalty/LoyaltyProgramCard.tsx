...
export function LoyaltyProgramCard({
  ...
  return (
    <section
      className={cn(
        "relative overflow-hidden rounded-[1.75rem] border border-[#D7B866]/40 bg-gradient-to-br from-[#FFFBF5] via-[#FFFDF9] to-[#F0E6D4] shadow-card",
        compact ? "p-5" : "p-5 sm:p-7"
      )}
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -right-8 top-0 h-32 w-32 rounded-full bg-[#D7B866]/20 blur-3xl"
      />
      <div className="relative z-10 space-y-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-1">
            <p className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.28em] text-[#A78335]">
              <Gift className="h-3.5 w-3.5 text-[#D7B866]" />
          ...
          <span className="rounded-full border border-[#D7B866]/40 bg-white px-3 py-1 text-[11px] font-bold text-[#641F2B]">
            Carte · {loyalty.fidelityCardLabel}
          </span>
        </div>

        <div className="rounded-2xl border border-[#D7B866]/25 bg-white/80 p-4 space-y-3">
          <div className="flex items-center justify-between text-sm">
            <span className="font-semibold text-[#2B2421]">
              Mois {Math.min(loyalty.consecutiveMonths, 12)} sur 12
              {loyalty.consecutiveMonths > 12
                ? ` · total ${loyalty.consecutiveMonths}`
                : ""}
            </span>
            <span className="text-xs text-[#A78335] font-bold">
              {loyalty.bonusActive
          ...
          <div className="h-2.5 overflow-hidden rounded-full bg-[#E8D5B5]">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#D7B866] to-[#641F2B] transition-all"
              style={{ width: `${progress}%` }}
            />
          </div>
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="rounded-xl border border-[#D7B866]/20 bg-[#EFE5DA]/60 p-2.5">
              <p className="text-[10px] font-bold uppercase tracking-wide text-[#A78335]">
                Prochaine récompense
              </p>
              <p className="mt-1 font-semibold text-[#2B2421]">
            ...
            <div className="rounded-xl border border-[#D7B866]/20 bg-[#EFE5DA]/60 p-2.5">
              ...
              <p className="mt-1 font-semibold text-[#2B2421] inline-flex items-center gap-1">
                <Zap className="h-3.5 w-3.5 text-[#D7B866]" />
        ...
        {!compact ? (
          <details className="rounded-xl border border-[#D7B866]/25 bg-white/70 px-4 py-3 text-sm">
            <summary className="cursor-pointer font-semibold text-[#641F2B]">
              En savoir plus
            </summary>
            <ul className="mt-2 space-y-1.5 text-xs text-[#2B2421]/70 list-disc pl-4">
          ...
          <Link
            ...
            className="inline-flex text-xs font-bold text-[#641F2B] underline"
          >
            Voir le programme →
          </Link>
        )}
...
export function LoyaltyRewardReveal({
  ...
  return (
    <div className="loyalty-reward-reveal fixed inset-0 z-[80] flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-md overflow-hidden rounded-[1.75rem] border-2 border-[#D7B866]/50 bg-gradient-to-br from-[#FFFBF5] to-[#F0E6D4] p-6 shadow-elevated text-center space-y-4">
        ...
        <h2 className="relative font-serif text-2xl font-bold text-[#2B2421]">
          {milestone
            ? "Félicitations ! Nouveau palier"
            : "Merci pour votre fidélité !"}
        </h2>
        <p className="relative text-sm text-[#2B2421]/70">
          Vous venez de recevoir :
        </p>
        <ul className="relative space-y-2 text-sm font-semibold text-[#2B2421]">
        ...
        <button
          type="button"
          onClick={onContinue}
          className="relative inline-flex h-11 w-full items-center justify-center rounded-xl bg-[#641F2B] text-sm font-bold text-[#FFFDF9]"
        >
          Continuer
        </button>
      </div>
...
export function PricingLoyaltyTeaser() {
  return (
    <section className="rounded-[1.75rem] border border-[#D7B866]/35 bg-gradient-to-br from-[#FFFBF5] via-white to-[#FFFDF9] p-6 sm:p-8 shadow-card space-y-3">
      ...
      <p className="text-sm text-[#2B2421]/70 leading-relaxed max-w-2xl">
      ...
      <ul className="grid sm:grid-cols-2 gap-2 text-xs text-[#2B2421]/75">
        <li className="rounded-xl border border-[#D7B866]/20 bg-white/80 px-3 py-2">
