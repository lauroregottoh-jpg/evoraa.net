...
export function CoffreUnlockSection({ resources, isPaid, onUnlockCta }: Props) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-primary/20 bg-gradient-to-br from-[#2A1216] via-[#7F5557] to-[#3D2A14] text-[#F2EBE0] shadow-elevated">
      <div
