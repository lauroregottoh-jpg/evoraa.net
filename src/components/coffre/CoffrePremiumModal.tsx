...
export function CoffrePremiumModal({ open, onClose, resourceTitle }: Props) {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="absolute inset-0 bg-[#1C1412]/55 backdrop-blur-[2px] animate-in fade-in duration-300"
        aria-label="Fermer"
        onClick={onClose}
      />
      <div className="relative w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl border border-border bg-[#F8F4EE] shadow-elevated overflow-hidden animate-in fade-in slide-in-from-bottom-4 sm:zoom-in-95 duration-300">
        ...
        >
          <div className="absolute inset-0 opacity-30 bg-[radial-gradient(circle_at_70%_20%,rgba(248,244,238,0.35),transparent_50%)]" />
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="p-5 sm:p-6 space-y-4">
          ...
          <ul className="space-y-2.5">
            {[
              ...
              "Téléchargements PDF sécurisés, à votre rythme",
