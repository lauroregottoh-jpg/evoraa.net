    ...
    <div className="space-y-8">
      <section className="rounded-2xl border border-[#7F5557]/15 bg-[#F2EBE0] p-5 sm:p-6 space-y-5">
        ...
        <div className="space-y-2">
          ...
          {saved ? (
            <p className="text-xs text-[#7F5557]">Préférence enregistrée.</p>
          ) : null}
        </div>
      </section>

      {!hideHistoryPlaceholder ? (
        <section className="rounded-2xl border border-[#7F5557]/10 bg-white p-5 sm:p-6 space-y-3">
          <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#B8954A]">
            Suivre mes sessions
          </p>
          ...
          {linked.length > 0 ? (
            ...
            <p className="text-sm text-[#7F5557]/60 leading-relaxed">
        ...
        <section className="rounded-2xl border border-[#7F5557]/10 bg-white p-5 space-y-2">
