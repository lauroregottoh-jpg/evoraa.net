...
export function CoachingSessionRoom({
  ...
  return (
    <div className="rounded-2xl border border-[#5C1F28]/25 bg-gradient-to-br from-[#2B2421] via-[#3D1519] to-[#5C1F28] text-[#FBF9F6] overflow-hidden">
      ...
      <div className="p-5 sm:p-6 space-y-4 bg-[#FBF9F6] text-[#2B2421]">
