      ...
      <div className="max-w-lg mx-auto space-y-6 pb-10">
        ...
        >
          ...
          <button
            ...
            className="w-full h-11 rounded-xl bg-[#2D1020] text-[#F2EBE0] text-sm font-bold disabled:opacity-60"
          >
      ...
      <div className="max-w-3xl mx-auto pb-10">
        <CoachingLockOverlay>
          <div className="min-h-[28rem] space-y-4 p-2">
            <div className="rounded-[1.75rem] border border-[#B8954A]/35 bg-gradient-to-br from-[#2D1020] to-[#2D1020] p-8 text-[#F2EBE0]">
              <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#D4AF72]">
                Faire votre session
              </p>
              <h1 className="mt-2 font-serif text-3xl font-bold">
