        ...
        return (
          <button
            ...
            className={cn(
              ...
              "bg-[#F2EBE0] shadow-card hover:shadow-elevated hover:-translate-y-1",
              isOn
          ...
          >
            ...
            >
              <span className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#D4AF72]/70 bg-black/25 text-[#D4AF72] shadow-lg">
                <Icon className="h-6 w-6" strokeWidth={2.25} />
              </span>
            </div>
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#2D1020]/70">
              {s.label}
            </p>
            <h3 className="mt-1.5 font-serif text-lg sm:text-xl font-bold text-[#2D1020] leading-snug">
              {s.title}
            </h3>
            <p className="mt-2 text-sm text-[#2D1020]/70 leading-relaxed">
              {s.body}
            </p>
            <span
              className={cn(
                "mt-4 inline-flex text-xs font-semibold transition-colors",
                isOn ? "text-accent" : "text-[#2D1020]/45 group-hover:text-primary"
              )}
            >
