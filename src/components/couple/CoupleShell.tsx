            ...
            <Link
              ...
              className={cn(
                ...
                active
                  ...
                  : "bg-[#F3EEE6] text-[#1C1412]/75 hover:bg-[#E8DFD2]"
              )}
            >
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "bg-gradient-to-br from-[#5C1F28] via-[#3D1519] to-[#1C1412] p-6 sm:p-8 text-[#FBF9F6]",
...
export function CoupleDashTile({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-4 font-serif text-xl font-bold text-[#1C1412]">
        {title}
      </h3>
      <p className="mt-1.5 text-sm text-[#1C1412]/65 leading-relaxed flex-1">
        {description}
      </p>
      {status ? (
