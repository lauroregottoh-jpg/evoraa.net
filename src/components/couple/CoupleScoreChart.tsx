  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-baseline justify-between gap-2">
        <span className="text-sm font-semibold text-[#1C1412]">{name}</span>
        <span className="font-serif text-xl font-bold text-[#5C1F28]">{value}%</span>
      </div>
      <div className="h-3.5 overflow-hidden rounded-full bg-[#1C1412]/08">
        <div
    ...
    >
      <figcaption className="mb-4 flex flex-wrap items-end justify-between gap-2">
        <div>
          ...
          <p className="font-serif text-lg sm:text-xl font-bold text-[#1C1412]">{label}</p>
        </div>
        <p className="text-sm text-[#1C1412]/70">
          Convergence{" "}
      ...
      <svg
        viewBox="0 0 200 28"
        className="mt-5 w-full text-[#1C1412]/15"
        aria-hidden
      >
