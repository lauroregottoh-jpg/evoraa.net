...
export function CoupleLanding() {
  ...
  return (
    <div ref={rootRef} className="bg-[#F2EBE0] text-[#7F5557]">
      <PageHero
              ...
              <span
                ...
                className={cn(
                  ...
                  activeSit === i
                    ...
                    : "border-[#7F5557]/20 text-[#7F5557]/35"
                )}
              >
                {i + 1}
              </span>
              ...
              {LANDING_SITUATIONS.map((s, i) => (
                <li
                  ...
                  className={cn(
                    ...
                    activeSit === i ? "border-accent" : "border-[#7F5557]/12"
                  )}
                >
                  ...
                  <p className="mt-3 text-base sm:text-lg text-[#7F5557] leading-relaxed">
                    {s.body}
                  </p>
                </li>
              ))}
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-14 sm:py-16 bg-[#EDE6DC] border-y border-[#7F5557]/8">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-[1fr_1.15fr] gap-10 lg:gap-14 items-start">
          ...
          <ul className="ck-reveal space-y-4">
            {LANDING_HERO.tensions.map((t) => (
              <li
                key={t}
                className="flex gap-3 text-base sm:text-lg leading-relaxed text-[#7F5557]"
              >
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-14">
            <div className="ck-reveal space-y-3">
              ...
              <p className="text-base sm:text-lg text-[#7F5557] leading-relaxed">
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-20 bg-[#7F5557] text-[#F2EBE0]">
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {LANDING_REPORT_PILLARS.items.map((item) => (
              <article
                key={item.title}
                className={cn(
                  "ck-reveal rounded-2xl p-5 sm:p-6 bg-gradient-to-br text-[#F2EBE0] border border-white/10",
                  item.accent
                )}
              >
      ...
      {/* 05 — Rapport 2×2 */}
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-20 bg-[#EDE6DC] border-y border-[#7F5557]/8">
        <div className="max-w-5xl mx-auto space-y-10">
          <div className="ck-reveal max-w-2xl space-y-3">
            <p className="couple-chapter text-xs font-bold uppercase text-primary">
          ...
          <div className="grid sm:grid-cols-2 gap-x-10 gap-y-10">
            {LANDING_REPORT_BLOCKS.map((b) => (
              <article
                key={b.title}
                className="ck-reveal space-y-3 border-t border-[#7F5557]/12 pt-5"
              >
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-20 bg-[#F2EBE0]">
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="ck-reveal space-y-3 rounded-2xl bg-[#E8DFD2] border border-[#7F5557]/10 p-6 sm:p-8">
            <p className="couple-chapter text-xs font-bold uppercase text-primary">
              06 — Et ensuite
            </p>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold">
            ...
            <p className="text-base sm:text-lg text-[#7F5557]">
          ...
          <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
            {LANDING_TOOLS.items.map((item, i) => (
              <div
                key={item.title}
                className="ck-reveal space-y-2 rounded-2xl border border-[#7F5557]/08 bg-[#FFFCF8] p-5 sm:p-6 shadow-sm"
              >
                <p className="font-mono text-sm font-bold text-[#B8954A]">
                  {String(i + 1).padStart(2, "0")}
                </p>
                <h3 className="font-serif text-xl sm:text-2xl font-bold text-[#7F5557]">
                  {item.title}
                </h3>
                <p className="text-base sm:text-lg text-[#7F5557]/80 leading-relaxed">
                  {item.body}
                </p>
              </div>
            ))}
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-20 bg-[#EDE6DC] border-y border-[#7F5557]/8">
        <div className="max-w-4xl mx-auto">
          <div className="ck-reveal mb-10 space-y-2">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#7F5557]">
              Comment ça se passe
            </h2>
          </div>
          <div className="grid grid-cols-[auto_1fr] gap-x-6 sm:gap-x-10">
            ...
            <ol className="space-y-6 pb-2">
              {LANDING_STEPS.map((step) => (
                <li
                  key={step.n}
                  className="ck-reveal rounded-xl border border-[#7F5557]/12 bg-[#F2EBE0] px-4 py-4 sm:px-5 sm:py-5"
                >
                  <p className="font-mono text-sm font-bold text-accent">
                    {step.n}
                  </p>
                  <p className="font-serif text-xl sm:text-2xl font-bold text-[#7F5557]">
                    {step.title}
                  </p>
                  <p className="mt-2 text-base sm:text-lg text-[#7F5557] leading-relaxed">
                    {step.body}
                  </p>
                </li>
              ))}
      ...
      {/* 09 — Offres */}
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-24 bg-[#F2EBE0]">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="ck-reveal max-w-2xl space-y-3">
            <p className="couple-chapter text-xs font-bold uppercase text-primary">
              09 — Niveaux d’accompagnement
            </p>
            <h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#7F5557] underline decoration-accent/60 underline-offset-8">
              {LANDING_OFFERS.eyebrow}
            </h2>
          </div>

          <div className="grid md:grid-cols-2 gap-8 md:gap-10">
            <article className="ck-reveal space-y-5 rounded-2xl border-2 border-[#7F5557]/15 bg-white p-6 sm:p-8 shadow-sm">
              <h3 className="font-serif text-3xl font-bold text-[#7F5557]">
                Bilan Premium
              </h3>
              <CoupleOfferPrice offerId="couple_essential" />
              <p className="text-base sm:text-lg text-[#7F5557] leading-relaxed font-medium">
                {LANDING_OFFERS.essentialFor}
              </p>
              <ul className="space-y-3 text-base sm:text-lg text-[#7F5557]">
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-24 bg-[#F3EEE6]">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-[1fr_1.05fr] gap-12 items-center">
          ...
          <div className="ck-reveal space-y-5 rounded-2xl bg-[#E8DFD2]/70 border border-[#7F5557]/10 p-6 sm:p-8">
            <p className="couple-chapter text-xs font-bold uppercase text-primary">
              10 — Imaginez
            </p>
            <h2 className="font-serif text-3xl sm:text-4xl font-bold leading-tight text-[#7F5557]">
            ...
            <p className="text-base sm:text-lg font-semibold text-[#7F5557]">
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-20 bg-[#F2EBE0]">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-[1fr_1.05fr] gap-10 lg:gap-14 items-center">
          <div className="space-y-6">
            <h2 className="ck-reveal font-serif text-3xl sm:text-5xl font-bold leading-tight text-[#7F5557]">
              {LANDING_CLOSING.title}
            </h2>
            <p className="ck-reveal text-lg sm:text-xl text-[#7F5557] leading-relaxed font-medium">
          ...
          <div className="ck-reveal relative aspect-[4/5] sm:aspect-[5/4] lg:aspect-[4/5] overflow-hidden rounded-2xl border border-[#7F5557]/10 shadow-sm">
            <Image
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-16 sm:py-20 bg-[#EDE6DC]">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-14 items-center">
          ...
          <div className="ck-reveal order-1 lg:order-2 space-y-6 rounded-2xl bg-[#F2EBE0] border border-[#7F5557]/10 p-6 sm:p-8">
            <p className="couple-chapter text-xs font-bold uppercase text-primary">
            ...
            <p className="text-lg sm:text-xl font-semibold text-[#7F5557]">
              {LANDING_CLOSING.start}
            </p>
            <p className="text-base text-[#7F5557] italic">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-3">
            {LANDING_FAQ.map((item) => (
              <details
                key={item.q}
                className="ck-reveal group rounded-xl border border-[#7F5557]/10 bg-white px-5 py-4 open:shadow-sm"
              >
                <summary className="cursor-pointer list-none font-serif text-lg sm:text-xl font-bold text-[#7F5557] pr-8 relative after:content-['+'] after:absolute after:right-0 after:top-0 after:text-primary after:font-sans after:text-xl group-open:after:content-['–']">
                  {item.q}
                </summary>
                <p className="mt-3 text-base text-[#7F5557]/80 leading-relaxed">
                  {item.a}
                </p>
              </details>
            ))}
          </div>
          <p className="ck-reveal text-sm text-[#7F5557]/60">
