...
body{font-family:Georgia,"Times New Roman",serif;color:#1C1412;line-height:1.65;font-size:14pt;background:#fff}
    ...
    return (
      <div className="space-y-8 text-[14pt] leading-[1.65]">
        {doc.exercises.map((ex) => (
          <div key={ex.id} className="space-y-3 border-t border-[#1C1412]/10 pt-6">
  ...
  return (
    <ol className="space-y-5 text-[14pt] leading-[1.65]">
      {doc.actionPlan.map((step) => (
        <li key={step.order} className="border-t border-[#1C1412]/10 pt-4">
...
function A4Page({
  ...
  return (
    <section
      id={`ch-${ch.id}`}
      className={cn(
        "report-a4 mx-auto w-full max-w-[210mm] bg-white text-[#1C1412] shadow-md border border-[#1C1412]/10",
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
        ...
        <button
          ...
          className="print:hidden inline-flex h-10 shrink-0 items-center gap-1.5 rounded-xl border border-[#1C1412]/15 bg-[#FBF9F6] px-3 text-[12pt] font-semibold"
        >
...
export function CoupleReportView({
  ...
  return (
    <article
      className={cn(
        "mx-auto w-full max-w-[240mm] pb-20 text-[#1C1412] print:max-w-none",
        className
      )}
      style={
        {
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 print:hidden mb-5">
        <button
          ...
          className="inline-flex h-11 items-center gap-2 rounded-xl border border-[#1C1412]/15 bg-white px-4 text-[14pt] font-semibold"
        >
      ...
      <header className="relative overflow-hidden rounded-[1.25rem] border border-[#B8954A]/35 bg-gradient-to-br from-[#5C1F28] via-[#3D1519] to-[#1C1412] p-6 sm:p-8 text-[#FBF9F6] mb-6 print:hidden">
      ...
      <nav className="mb-6 rounded-2xl border border-[#1C1412]/10 bg-[#F8F4EE]/90 p-4 print:hidden">
      ...
      {focusOne ? (
        <div className="space-y-4 print:hidden">
          <div className="flex items-center justify-between gap-3">
            <p className="text-[12pt] text-[#1C1412]/55">
      ...
      <footer className="pt-8 border-t border-[#1C1412]/10 space-y-2 text-[12pt] text-[#1C1412]/50">
        <p>
