...
function MatchCard({
  ...
  return (
    <article
      className="sim-match-card group relative overflow-hidden rounded-2xl border border-[#D7B866]/30 bg-white shadow-card"
    ...
    >
      ...
      >
        ...
        {thread.verified ? (
          <span className="absolute top-2.5 left-2.5 inline-flex items-center gap-1 rounded-md bg-[#E8D49A] px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wide text-[#2B2421]">
            <Crown className="h-2.5 w-2.5" /> Vérifié
          </span>
        ) : null}
        <span className="absolute left-2.5 bottom-14 z-10 rounded-md border border-dashed border-white/70 bg-[#641F2B]/85 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-widest text-[#E8D49A]">
          Démo
        </span>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 text-white">
          ...
          <p className="mt-1 text-[10px] font-semibold uppercase tracking-wide text-[#E8D49A]">
            {thread.matchedLabel}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-3 p-3.5">
        ...
        <Link
          ...
          className="sim-open-msg inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl bg-[#641F2B] text-xs font-bold text-[#FFFDF9] transition hover:bg-[#641F2B]/90"
        >
  ...
  return (
    <section
      className={cn(
        ...
        variant === "alliance"
          ? "border-dashed border-[#D7B866]/50 bg-gradient-to-br from-[#FFFBF5] via-[#FFFDF9] to-[#F0E6D4]"
          : "border-dashed border-[#D7B866]/40 bg-gradient-to-br from-[#FFFBF5] via-[#FFFDF9] to-[#F3E8D0]"
      )}
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -right-10 top-0 h-40 w-40 rounded-full bg-[#D7B866]/15 blur-3xl"
      />
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-1.5">
            <p className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.28em] text-[#A78335]">
              ...
              <Sparkles className="h-3.5 w-3.5 text-[#D7B866] discovery-spark" />
            ...
            <p className="max-w-lg text-sm text-[#2B2421]/65 leading-relaxed">
              ...
              <span className="font-semibold text-[#641F2B]">simulées</span>. Elles
          ...
          <div className="flex items-center gap-2">
            {unread > 0 ? (
              <span className="rounded-full bg-[#641F2B] px-3 py-1 text-[11px] font-bold text-[#FFFDF9]">
                {unread} non lu{unread > 1 ? "s" : ""}
              </span>
            ) : null}
            <Link
              href="/messages"
              className="rounded-full border border-[#D7B866]/40 bg-white px-3 py-1 text-[11px] font-bold text-[#641F2B] hover:bg-[#EFE5DA]"
            >
              Messages →
            </Link>
          </div>
