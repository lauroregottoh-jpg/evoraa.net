  ...
  return (
    ...
    >
      ...
      >
        ...
        {thread.verified ? (
          <span className="absolute top-2.5 left-2.5 inline-flex items-center gap-1 rounded-md bg-[#F3D9A4] px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wide text-[#1C1412]">
      ...
      <div className="space-y-3 p-3.5">
        <p className="line-clamp-2 text-xs leading-relaxed text-[#1C1412]/70">
          {thread.preview}
        </p>
        <Link
