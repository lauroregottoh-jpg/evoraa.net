...
export function DiscoveryWelcomeHero({
  ...
  return (
    <section className="rounded-[1.75rem] border border-border/50 bg-[#FCFAF6] px-5 py-8 sm:px-8 sm:py-10">
      <div className="text-center space-y-3">
        ...
        <h1 className="font-serif text-3xl sm:text-4xl font-bold text-[#641F2B] leading-tight">
