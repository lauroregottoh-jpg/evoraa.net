...
export function DiscoveryPathVisual({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-[#B8954A]/35 bg-gradient-to-br from-[#FFFBF5] via-[#F8F4EE] to-[#F0E6D4] text-[#2B2421] shadow-card">
      <div
        aria-hidden
                ...
                >
                  <span
                    className={cn(
                      ...
                      isGoal
                        ? "border-[#B8954A] bg-gradient-to-br from-[#F3D9A4] to-[#B8954A] text-[#2B2421] discovery-goal-pulse"
                        : isActive
                ...
                >
                  <div
                    className={cn(
                      ...
                      isActive
                        ? "border-[#B8954A] bg-gradient-to-br from-[#F3D9A4] to-[#B8954A] text-[#2B2421] discovery-step-pulse"
                        : isDone
