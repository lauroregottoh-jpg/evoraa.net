...
export function DiscoveryRapportTeaser({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5 pb-10">
      <header className="rounded-[1.75rem] border border-primary/20 bg-gradient-to-br from-[#7F5557] via-[#722F37] to-[#8B5C62] p-6 sm:p-8 text-[#F2EBE0] shadow-elevated">
        ...
        <Link
          ...
          className="mt-5 inline-flex h-12 items-center gap-2 rounded-xl bg-[#B8954A] px-5 text-sm font-bold text-[#7F5557]"
        >
      ...
      <div className="relative overflow-hidden rounded-[1.75rem] border-2 border-[#B8954A]/40 shadow-elevated">
        ...
        >
          <div className="bg-gradient-to-br from-[#7F5557] via-[#7F5557] to-[#7F5557] text-[#F2EBE0] p-8 sm:p-10">
        ...
        {/* Overlay cadenas */}
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-[#7F5557]/45 backdrop-blur-[1px] px-6 text-center">
          <div className="flex h-24 w-24 sm:h-28 sm:w-28 items-center justify-center rounded-full border-2 border-[#B8954A] bg-[#7F5557]/85 shadow-[0_0_40px_rgba(215,184,102,0.35)]">
          ...
          <Link
            href="/premium?next=/rapport"
            className="mt-5 inline-flex h-12 items-center gap-2 rounded-xl bg-[#B8954A] px-6 text-sm font-bold text-[#7F5557]"
          >
            <Crown className="h-4 w-4" />
...
function FakePage({ title, lines }: { title: string; lines: string[] }) {
  return (
    <div className="rounded-[1.35rem] border border-[#B8954A]/30 bg-white p-5 space-y-2">
      ...
      <h3 className="font-serif text-xl font-bold text-[#7F5557]">{title}</h3>
      {lines.map((line) => (
