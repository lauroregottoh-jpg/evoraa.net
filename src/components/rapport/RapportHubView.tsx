...
export function RapportHubView({
  ...
  return (
    <article className="space-y-5 max-w-3xl mx-auto">
      <header className="rapport-reveal relative overflow-hidden rounded-[1.75rem] border-2 border-[#B8954A]/45 bg-gradient-to-br from-[#7F5557] via-[#7F5557] to-[#7F5557] p-6 sm:p-8 text-[#F2EBE0] shadow-elevated">
        <div
          aria-hidden
        ...
        <div className="relative z-10 mt-6 flex flex-wrap gap-2">
          <Link
            href="/rapport/global"
            className="inline-flex h-12 items-center gap-2 rounded-xl bg-[#B8954A] px-5 text-sm font-bold text-[#7F5557] hover:brightness-105 transition"
          >
      ...
      <section className="rapport-reveal rapport-page-premium rounded-2xl border border-[#B8954A]/35 p-5 sm:p-6 space-y-4 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <Link
            href="/rapport/global"
            className="inline-flex h-12 flex-1 items-center justify-center gap-2 rounded-xl bg-[#B8954A] px-4 text-sm font-bold text-[#7F5557]"
          >
