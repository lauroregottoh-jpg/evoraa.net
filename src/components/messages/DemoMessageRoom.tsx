  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-2xl flex-col overflow-hidden rounded-[1.5rem] border border-[#B8954A]/30 bg-[#FFFBF5] shadow-elevated">
      ...
      <div className="flex-1 space-y-3 overflow-y-auto px-4 py-5">
        <p className="demo-msg-in mx-auto mb-4 max-w-sm rounded-2xl border border-[#B8954A]/20 bg-white/70 px-3 py-2 text-center text-[11px] text-[#2B2421]/55">
            ...
            <div
              className={cn(
                ...
                m.fromMe
                  ...
                  : "rounded-bl-md border border-[#B8954A]/20 bg-white text-[#2B2421]"
              )}
            >
              <p>{m.text}</p>
              <p
