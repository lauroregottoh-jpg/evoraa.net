...
export function PwaInstallHomeSection() {
  ...
  return (
    <section className="relative py-12 sm:py-14 px-6 sm:px-12 lg:px-20">
      <div className="max-w-5xl mx-auto rounded-2xl border border-border/70 bg-gradient-to-r from-[#0F1F1A] to-[#1C1412] px-5 py-5 sm:px-8 sm:py-6 flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
