...
# Module 1 — Construire sa vie spirituelle

## Leçon : Prier un peu… mais vraiment
...
# 1. Pourquoi la régularité compte davantage que la durée
...
# 2. Construire une habitude de prière qui dure
...
# 3. Les habitudes qui renforcent une vie spirituelle
...
# 4. Les erreurs qui découragent le plus souvent
...
Pendant les cinq prochains jours, réserve cinq minutes à un moment fixe de la journée pour prier. À la fin de chaque temps, note en une phrase ce que tu retiens de cette rencontre avec Dieu.
...
# Module 2 — Mieux communiquer avant le mariage

## Leçon : Dire ce que l'on ressent... avant que le silence ne parle à notre place
...
# 1. Pourquoi les non-dits deviennent des problèmes
...
# 2. Identifier ce qui t'empêche de parler
...
# 3. Parler avec respect, même lorsqu'un sujet est difficile
...
# 4. Construire des habitudes qui renforcent la confiance
...
# Module 3 — Gérer les désaccords avec maturité

## Leçon : Les conflits ne sont pas le problème... la manière de les gérer l'est.
...
# 1. Les conflits sont inévitables, mais ils ne sont pas dangereux
...
# 2. Les réactions qui font dégénérer une dispute
...
# 3. Comment traverser un désaccord avec maturité
...
# 4. Faire de chaque conflit une occasion de grandir
...
# Module 4 — Respect, limites et intimité avant le mariage

## Leçon : Poser des limites n'est pas un manque d'amour
...
# 1. Pourquoi les limites sont indispensables
...
# 2. Les limites importantes avant le mariage
...
# 3. Comment parler de ses limites
...
# 4. Lorsque les limites ne sont pas respectées
...
# Module 5 — Préparer son futur foyer

## Leçon : Construire son couple sans oublier sa famille
...
# 1. Comprendre l'influence de la famille sur le couple
...
# 2. Honorer ses parents sans oublier son futur foyer
...
# 3. Savoir poser des limites avec respect
...
# 4. Construire une nouvelle équipe
...
# Module 6 — Parler d'argent avant le mariage

## Leçon : L'argent ne fait pas le bonheur... mais il mérite d'être discuté
...
# 1. Pourquoi parler d'argent avant de s'engager
...
# 2. Les conversations à ne pas éviter
...
# 3. La transparence construit la confiance
...
Prends un moment pour faire le point sur ta situation financière. Liste tes principales sources de revenus, tes dépenses régulières, tes éventuelles dettes et tes objectifs financiers. Si tu es en couple, choisissez un moment pour échanger sur votre vision de l'argent, sans chercher à convaincre l'autre, mais simplement à mieux vous comprendre.
...
# Module 7 — Mieux gérer ses émotions

## Leçon : Apprendre à gérer ses émotions avant de construire une relation durable
...
# 1. Les émotions ne sont pas tes ennemies
...
# 2. Les réactions qui fragilisent une relation
...
# 4. Développer une maturité émotionnelle
...
Pendant les sept prochains jours, prends quelques minutes chaque soir pour noter une émotion forte que tu as ressentie dans la journée. Écris ce qui l'a déclenchée, comment tu as réagi et ce que tu aurais pu faire différemment. Cet exercice t'aidera à mieux comprendre ton fonctionnement émotionnel.
...
# Module 8 — Construire un projet de vie à deux

## Leçon : Le mariage ne se prépare pas seulement avec de l'amour, mais aussi avec une vision commune
...
# 1. Pourquoi parler de l'avenir avant de s'engager
...
# 2. Les conversations à ne pas repousser
...
# 3. Construire une vision commune
...
# 4. Grandir ensemble au fil des années
