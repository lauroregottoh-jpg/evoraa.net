...
# Architecture de la Base de Données KELIA

Ce document référence l'intégralité de la structure de données de l'application KELIA, optimisée pour l'évolutivité, la sécurité (RLS) et la performance des algorithmes de matching.
