...
4. **Authenticité** : On ne triche pas sur qui l'on est (vraies photos, conversations sans filtre IA).
5. **Élégance** : Un design premium, digne des meilleures applications mondiales.
6. **Espérance** : L'application donne le sentiment que "la bonne personne est ici".
...
* **Simple** avant d'être complet.
* **Bienveillant** avant d'être performant.

### Règles strictes d'interface :
...
## 4. Règles Spécifiques aux Fonctionnalités

### La "Découverte de Soi"
* Les questions s'apparentent à du coaching introspectif.
...
* **Explication claire** des règles de la communauté.
...
> **La Mission Finale :**
> *Chaque écran, chaque interaction, chaque mot et chaque fonctionnalité doivent contribuer à une seule mission : aider deux personnes compatibles à se rencontrer dans un climat de confiance, de respect, de discernement et d'espérance.*

> **Règle de Gouvernance** : Aucune implémentation de code frontend ne sera réalisée par l'équipe (ou l'IA) sans vérifier qu'elle respecte cette Charte Produit. Si une décision s'en écarte, une alternative conforme devra être proposée.
